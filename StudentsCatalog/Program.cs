            ...
            while (true)
            {
                ...
                switch (option)
                {
                    ...
                    case "10":
                        ...
                        break;
                    case "11":
                        Console.Write("Enter student ID to update teacher's name: ");
                        int updateTeacherNameId = int.Parse(Console.ReadLine());
                        catalog.UpdateTeacherName(updateTeacherNameId);
                        break;
                    case "12":
                        return;
                    default:
